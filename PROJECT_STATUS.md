...
- [x] Phase 5 — Full dataset: 376+ destinations across 4 provinces (KPK, Punjab, Sindh, Balochistan), 3 territories (Gilgit-Baltistan, Azad Kashmir, Islamabad Capital Territory), and 161+ cities & districts, with non-null budgets, recommended days, and seasons.
- [x] Phase 5.5 — 100% real, verified Wikimedia Commons photos with proper license & attribution for the original 154 destinations. ⚠️ Dataset has since grown to 376+ destinations (161+ districts) — re-run `check_status.py` and `scripts/fetch_real_images.py` to confirm image coverage for the newer entries before marking this 100% complete again.
...
- Database: SQLite `travel.db` containing 376+ destinations across 161+ cities & districts, with images.
